...
final class SqliteCteShadowComposerTest extends TestCase
{
    ...
    public function testDeclaredCteNamesReadsQuotedAndColumnListedCteNames(): void
    {
        self::assertSame(
            ['first', 'second'],
    ...
    public function testCarryPrefixCarriesTheCompleteCteHeaderOntoARewrittenDmlProjection(): void
    {
    ...
    public function testStatementSqlExtractsTheStatementFollowingTheCteHeader(): void
    {
        self::assertSame(
