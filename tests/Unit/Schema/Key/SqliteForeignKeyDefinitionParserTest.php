...
use ZtdQuery\Platform\Sqlite\Schema\Key\SqliteForeignKeyDefinitionParser;
...
{
    public function testParseCreateTableParsesNamedCompositeConstraintWithoutRegexSubstitution(): void
    {
