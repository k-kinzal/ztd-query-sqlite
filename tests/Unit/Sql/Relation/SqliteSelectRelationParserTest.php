...
{
    public function testTableNamesFindsSqliteQuotedAndNestedRelations(): void
    {
    ...
    public function testUnqualifyReferencesPreserveOffsetsAndUnqualifyOnlyTargets(): void
    {
        $parser = new SqliteSelectRelationParser();
    ...
    public function testIdentifierComponentRejectsMismatchedTokenKind(): void
    {
        ...
        self::assertNull((new \ZtdQuery\Platform\Sqlite\Sql\Relation\RelationSourceParser())->identifierComponentAt([$token], 0));
    }
}
